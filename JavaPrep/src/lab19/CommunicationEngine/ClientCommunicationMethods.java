...
//    public void listenPhase(Client client, SongData songData){
//
//        for(Songs )
//
//        filteredSongs.forEach(songs -> {
//            if (songs.getName().equals(choiceSong)){
//                System.out.println("You re listening");
//                stopwatch.stopwatch(songs, scanner);
//                System.out.println("Did you like the song?");
//                String likeChoice = scanner.nextLine();
//                if(likeChoice.equals("Y")){
////                    client.getLibrary().getLibraryList().add(new Playlists("Liked"))
//                    songs.setLiked(true);
//                }
//            }
//        });
